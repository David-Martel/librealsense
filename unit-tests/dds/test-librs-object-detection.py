...
#   - Server creates a device with an object_detection_stream_server and
#     publishes detection JSON.
#   - Client uses pyrealsense2 (LibRS) to receive and parse frames through the
#     object_detection_frame API.
