...
def test_ts_eof():
    ...
    #############################################################################################
    log.debug( "Stop giving color; nothing output" )
    ...
    if rs_convert:
        ...
        log.warning( 'no rs-convert was found!' )
        import sys
        log.debug( 'sys.path=\n    ' + '\n    '.join( sys.path ) )

    #############################################################################################
    log.debug( "Play it back, with syncer -- lose last frame" )
    ...
    #############################################################################################
    log.debug( "Play it back, without syncer -- and now expect the lost frame" )
